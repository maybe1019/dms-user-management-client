                            ...
                            <div class="relative w-auto my-6 mx-auto  max-h-[463px]  min-w-[586px] ">
                                   ...
                                   <div
                                          ...
                                          <div
                                                 ...
                                                 <button class=" text-center w-[200px] h-[50px]  border border-[#DEE0E4] font-medium  bg-white   font-roboto  text-[14px] text-[#757575] rounded-[4px] outline-none focus:outline-none  ease-linear transition-all duration-150"
