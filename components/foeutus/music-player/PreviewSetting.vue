<template>
              ...
              <div class=" flex  flex-col w-full min-h-[600px]  border border-[0.5px] px-[45px] pb-[45px] space-y-[40px] rounded-[4px] py-[38px]">
                     ...
                     <div class="flex flex-row items-center space-x-[14px]">
                            ...
                            <av-waveform ref-link="player" :audio-controls="false" :canv-width="610" :canv-height="40"
                     ...
                     <div class="flex justify-items-start items-center space-x-[63.25px]">
